...
const VIPCard: React.FC = () => {
    ...
    if (!user) return (
        <div className="min-h-screen bg-[#050408] flex flex-col items-center justify-center p-8 text-center">
            <div className="w-16 h-16 bg-red-500/10 border border-red-500/20 rounded-full flex items-center justify-center mb-6">
                <span className="text-2xl">⚠️</span>
            </div>
            <h1 className="text-white font-bold text-lg mb-2">Member Card Not Found</h1>
            <p className="text-white/40 text-sm mb-8 max-w-xs">This VIP pass might have expired or was removed from the system.</p>
            <button
                onClick={() => {
